...
public class ViewBaseCharacteristicInfo implements KvmSerializable {
    ...
    public ViewBaseCharacteristicInfo(){}

    public ViewBaseCharacteristicInfo(SoapObject soapObject)
    {
        if (soapObject == null)
            return;

...
public class ViewBarcodeInfo implements KvmSerializable {
    
    public String formattedBarcode;
    public WS_Enums.BarcodeType barcodeType;
    public String barcodeTypeDescription;
    public String formattedBarcodeAndPrice;
    public int productId;
    public long barcode;
    public int barcodeTypeId;
    public double price=Float.NaN;
    ...
    public ViewBarcodeInfo(){}
    
    public ViewBarcodeInfo(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("FormattedBarcode"))
        {
            Object obj = soapObject.getProperty("FormattedBarcode");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                formattedBarcode = j.toString();
            }else if (obj!= null && obj instanceof String){
                formattedBarcode = (String) obj;
            }
        }
        if (soapObject.hasProperty("BarcodeType"))
        {
            Object obj = soapObject.getProperty("BarcodeType");
            if (obj!= null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive)obj;
                barcodeType = WS_Enums.BarcodeType.fromString(j.toString());
            }
        }
        if (soapObject.hasProperty("BarcodeTypeDescription"))
        {
            Object obj = soapObject.getProperty("BarcodeTypeDescription");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                barcodeTypeDescription = j.toString();
            }else if (obj!= null && obj instanceof String){
                barcodeTypeDescription = (String) obj;
            }
        }
        if (soapObject.hasProperty("FormattedBarcodeAndPrice"))
        {
            Object obj = soapObject.getProperty("FormattedBarcodeAndPrice");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                formattedBarcodeAndPrice = j.toString();
            }else if (obj!= null && obj instanceof String){
                formattedBarcodeAndPrice = (String) obj;
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 1:
                return barcodeType.toString();
            case 2:
                return barcodeTypeDescription;
            case 3:
                return formattedBarcodeAndPrice;
            case 4:
                return productId;
            case 5:
                return barcode;
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            case 0:
                ...
                info.name = "FormattedBarcode";
                break;
            case 1:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "BarcodeType";
                break;
            case 2:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "BarcodeTypeDescription";
                break;
            case 3:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "FormattedBarcodeAndPrice";
                break;
            case 4:

...
public class SaleOrdersFilter implements KvmSerializable {
...
//    public int quoteId;
    ...
    //    public int orderNumberFrom;
//    public int orderNumberTo;
    // public VectorSaleOrderStatus orderStatus;
...
//    public int purchaseOrderId;
    public String orderCreatedDateFrom;
    public String orderCreatedDateTo;
    public String expectedDeliveryDateFrom="";
    public String expectedDeliveryDateTo="";
    //    public String utmostDeliveryDateFrom;
//    public String utmostDeliveryDateTo;
//    public int prePaymentRequestNumber;
//    public int prePaymentNumber;
//    public WS_Enums.BooleanFilter isCancelledOnly;
//    public WS_Enums.BooleanFilter hasPendingPrePaymentsOnly;
    public WS_Enums.BooleanFilter isShowOpenSaleOrdersOnly;
//    public WS_Enums.BooleanFilter ordersWithRowsOnly;
//    public WS_Enums.BooleanFilter isOrderResponseSentOnly;
//    public WS_Enums.BooleanFilter isEdiSaleOrdersOnly;
//    public WS_Enums.BooleanFilter isExportedOnly;
//    public long conversionId;
//    public WS_Enums.SaleOrderApprovalStatus customerApprovalStatus;
//    public WS_Enums.SaleOrderApprovalStatus suppliersApprovalStatus;

    public SaleOrdersFilter() {
    }

    public SaleOrdersFilter(SoapObject soapObject) {
        if (soapObject == null)
            return;
...
//            }
//        }
        if (soapObject.hasProperty("OrderCreatedDateFrom")) {
            Object obj = soapObject.getProperty("OrderCreatedDateFrom");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)) {
                SoapPrimitive j = (SoapPrimitive) obj;
                orderCreatedDateFrom = j.toString();
            } else if (obj != null && obj instanceof String) {
                orderCreatedDateFrom = (String) obj;
            }
        }
        if (soapObject.hasProperty("OrderCreatedDateTo")) {
            Object obj = soapObject.getProperty("OrderCreatedDateTo");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)) {
                SoapPrimitive j = (SoapPrimitive) obj;
                orderCreatedDateTo = j.toString();
            } else if (obj != null && obj instanceof String) {
                orderCreatedDateTo = (String) obj;
            }
        }
...
//                return purchaseOrderId;
            case 2:
                return orderCreatedDateFrom;
            case 3:
                return orderCreatedDateTo;
//            case 4:
//                return orderStatus;
            case 8:
...
//                break;
            case 2:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "OrderCreatedDateFrom";
                break;
            case 3:
                info.type = PropertyInfo.STRING_CLASS;
                info.name = "OrderCreatedDateTo";
                break;
//            case 4:
...
//                break;
            case 8:
                if (expectedDeliveryDateFrom.trim().length() == 0) {
                    info.type = PropertyInfo.STRING_CLASS;
                    info.name = "ExpectedDeliveryDateFrom1";
                ...
                break;
            case 9:
                if (expectedDeliveryDateTo.trim().length() == 0) {
                    info.type = PropertyInfo.STRING_CLASS;
                    info.name = "ExpectedDeliveryDateTo1";
